...
admin_name = 'wookhuang'
admin_password='Moodle##5838108'
...
description = f'User added by {admin_name} via Python Selenium Automated script on {datetime.datetime.now()}' # fake.sentence(nb_words=100)
